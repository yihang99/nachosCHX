    ...
    protected class ThreadState {
		...
		*/
		public ThreadState(KThread thread) {
			this.thread = thread;
			holdQueue = new LinkedList<PriorityScheduler.PriorityQueue>();
		...
		*/
		...
		/**
		* Called when the associated thread has holdQueue access to whatever is
